...
function flash($message_title = '', $back_url = '', $pause = 3, $extra = '')
{
    ...
    $images = ['failed.png', 'success.png', 'notice.png'];
    $styles = ['error', 'true'];
...
function uses()
{
    ...
    foreach ($args as $arg) {
        ...
        if (is_file($model_file = LIB_PATH.'core/models/'.$class_name.'.php')) {
            include $model_file;
        }
    }
}
...
function parse_highlight($highlight, $return_color = false)
{
    if ($highlight) {
        ...
        $colorarray = ['#000000', '#FF0000', '#FFA500', '#FFFF00', '#008000', '#00FFFF', '#0000FF', '#800080', '#808080'];
...
function cache_read($file = null, $item = null, $prefix = true, $remove_params = null)
{
    ...
    $return = false;
    if ($prefix) {
        $file_name = CACHE_COMMON_PATH.'cache_'.$file.'.php';
    } else {
        $file_name = CACHE_COMMON_PATH.$file.'.php';
    }
...
function pb_lang_merge($inputs)
{
    ...
    foreach ($inputs as $key => $val) {
        if (pb_lang_enabled($key, $_languages)) {
            $ret .= '[:'.$key.']'.$val;
        }
    }
...
function pb_hidestr($string)
{
    ...
    $show = ['m_0', 'm_1', 'm_2', 'm_3', 'm_8', 'm_9', 'm_10', 'm_16', 'm_19', 'm_20', 'm_22', 'm_33', 'm_34', 'm_37', 'm_38', 'm_40', 'm_44', 'm_45', 'm_46', 'm_48'];
    $hide = ['m_4', 'm_5', 'm_6', 'm_7', 'm_11', 'm_12', 'm_13', 'm_14', 'm_15', 'm_17', 'm_18', 'm_21', 'm_23', 'm_24', 'm_25', 'm_26', 'm_27', 'm_28', 'm_29', 'm_30', 'm_31', 'm_32', 'm_35', 'm_36', 'm_39', 'm_41', 'm_42', 'm_43', 'm_47', 'm_49'];
