...
class Db_Mysqli
{
     ...
     * @param string $socket
     */
    public function __construct($host = null, $username = null, $password = null, $db = null, $port = 3306, $charset = 'utf8', $socket = null)
    {
        $isSubQuery = false;
     ...
     *
     * @uses $db = Db_Mysqli::getInstance();
     *
     * @return Db_Mysqli Returns the current instance.
     */
     ...
     *
     * @uses $Db_Mysqli->setQueryOption('name');
     *
     ...
     *
     * @return array|Db_Mysqli Contains the returned rows from the select query.
     * @throws Exception
     */
     ...
     *
     * @uses $Db_Mysqli->where('id', 7)->where('title', 'MyTitle');
     *
     ...
     *
     * @uses $Db_Mysqli->orWhere('id', 7)->orWhere('title', 'MyTitle');
     *
     * @param string $whereProp  The name of the database field.
     * @param mixed  $whereValue The value of the database field.
     * @param string $operator   Comparison operator. Default is =
     ...
     *
     * @uses $Db_Mysqli->having('SUM(tags) > 10')
     *
     ...
     *
     * @uses $Db_Mysqli->orHaving('SUM(tags) > 10')
     *
     * @param string $havingProp  The name of the database field.
     * @param mixed  $havingValue The value of the database field.
     * @param string $operator    Comparison operator. Default is =
     ...
     *
     * @uses $Db_Mysqli->join('table1', 'field1 <> field2', 'LEFT')
     *
     ...
     *
     * @uses $Db_Mysqli->orderBy('id', 'desc')->orderBy('name', 'desc', '^[a-z]')->orderBy('name', 'desc');
     *
    ...
    /**
     * Method creates new Db_Mysqli object for a subquery generation
     *
    ...
    /**
     * Method returns a copy of a Db_Mysqli subquery object
     *
     * @return Db_Mysqli new Db_Mysqli object
     */
    ...
    /**
     * Get where and what function was called for query stored in Db_Mysqli->trace
     *
    ...
    public function table_names($dbName = '')
    {
