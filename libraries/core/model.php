...
class PbModel
{
    ...
    public $page_secure = false;
    public $cache_sql = 0; //180 seconds, if no, set 0.
    ...
    public function setParams($extra = [])
    {
        $params = [];
        if (isset($_POST)) {
            $params['form'] = $_POST;
    ...
    public function setLimitOffset($offset, $limit)
    {
    ...
    public function del($ids, $conditions = null, $table = null)
    {
    ...
    public function save($posts, $action = null, $id = null, $tbname = null, $conditions = null, $if_check_word_ban = false)
    {
        $new_id = $result = false;
        ...
        if ($insertsql) {
            $result = $this->dbstuff->Execute($insertsql);
        }
    ...
    public function read($fields = null, $id = null, $tables = null, $conditions = null)
    {
        $tmp_tablename = null;
        if ($id !== null) {
            $this->id = $id;
    ...
    public function getFieldAliasNames()
    {
        $table_name = $this->getTable();
        $fields = null;
    ...
    public function getTable($alias = false, $join_name = '')
    {
        global $tb_prefix;
    ...
    public function findCount($joins = null, $conditions = null, $countfield = null, $table_alias = null)
    {
        if (!$this->page_secure) {
    ...
    public function findAll($fields = null, $joins = null, $conditions = null, $order = null, $limit = null, $offset = null, $recursive = null)
    {
    ...
    public function clicked($id, $additionalParams = true)
    {
        if ($additionalParams) {
    ...
    public function check($id = null, $status = 0)
    {
        if (is_array($id)) {
    ...
    public function saveField($name, $value, $id = null, $conditions = null)
    {
        if (is_array($id)) {
            $checkId = 'id in ('.implode(',', $id).')';
        } elseif (is_int($id)) {
    ...
    public function format_column($colname)
    {
        $new_column_name = null;
        if (strstr($colname, '_')) {
            $tmp_col = explode('_', $colname);
            foreach ($tmp_col as $val) {
                $new_column_name .= ucfirst(strtolower($val));
            }
        } else {
    ...
    public function doValidation($arr)
    {
    ...
    public function findIt($table_name, $parent_id = 0)
    {
        $this->dbstuff->setFetchMode(ADODB_FETCH_ASSOC);
    ...
    public function getIncludeIds($list)
    {
    ...
    public function getExcludeIds($list)
    {
    ...
    public function getNeighbour($id, $fields = '*')
    {
        $ret = [];
     ...
     */
    public function checkException($inputs, $exceptions)
    {
