...
if (!defined('LIB_PATH')) {
    define('LIB_PATH', PHPB2B_ROOT.'libraries'.DS);
}
require '../libraries/global.func.php';
require '../libraries/func.sql.php';
require '../libraries/db_mysqli.inc.php';
...
function showLanguages($return_arr = false)
{
    ...
    while (false !== $file = (readdir($handle))) {
        $dir = $path.$file;
        if (is_dir($dir) && !in_array($file, ['.', '..', '.svn'])) {
